      ...
      <table className="table table--orders tableNarudzbe">
        <thead className="table__thead">
          <tr>
            ...
            <th scope="col" className="table__th order__user">
              Korisnik
            </th>
          ...
          {reversedIds.map((id, index) => {
            ...
            return (
              <tr key={index} className="table__row order">
                ...
                <td className="table__cell order__user">{order.userId}</td>
                <td className="table__cell order__amount">{order.amount} KM</td>
