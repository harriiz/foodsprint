...
import CartItem from "../../features/menus/CartItemRestoran";
...
function AsideKorpa() {
  ...
  return (
    <div className="asideKorpa">
      <div className="asideContainerKorpa">
        <div className="korpaContainerKorpa">
